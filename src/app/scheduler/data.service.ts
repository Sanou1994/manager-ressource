...
export class DataService {
  ...
  resources: DayPilot.ResourceData[] = [
    ...
    {
      name: 'Group C', id: 'GC', expanded: true, children: [
        {name: 'Resource 9', id: 'R9', capacity: 20},
        {name: 'Resource 10', id: 'R10', capacity: 40},
        {name: 'Resource 11', id: 'R11', capacity: 20},
        {name: 'Resource 12', id: 'R12', capacity: 40}
      ]
    }
  ];
